...
class FAQs extends Component {
  ...
  render() {
    return (
      <div>
      <div className="fleftLoginFAQ">
                          <div className="FAQ-F">
                    <p className="FAQ-P">
                      <h4 onClick={ () => this.handleClick() }>What is the purpose of this site?</h4>
                    </p>
                    ...
                    <div className="FAQ-F">
                    <p className="FAQ-P">
                      <h4 onClick={ () => this.handleClick() }>How can I register my lost vehicle with this site?</h4>
                    </p>
                    <ToggleDisplay show={this.state.show}>
                    ...
                    <div className="FAQ-F">
                    <p className="FAQ-P">
                      <h4 onClick={ () => this.handleClick() }>How do understand, whether my vehicle is register with this site or not?</h4>
                    </p>
                    <ToggleDisplay show={this.state.show}>
                    Once you finished the registration process of the Missing Vehicle Section you will received the system generated email from us.
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>What is the use of the login credentials which I have received from you, after completion of the Missing Vehicle registration process?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>What process will happen after Missing Vehicle registration?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>Which section should I use to register a found vehicle?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>In regards to Found Vehicle, what is the meaning of rewards?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>How much time it will take to track my vehicle?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>What should I do if I received the Vehicle Matching emails from you?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>What will happen if I collect my vehicle from somewhere else?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>How can I place my company advertisement on your portal?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>What will happen, if I complete the registration process of Advertisement?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
                        ...
                        <div className="FAQ-F">
                        <p className="FAQ-P">
                          <h4 onClick={ () => this.handleClick() }>How can I choose my period of Advertisement?</h4>
                        </p>
                        <ToggleDisplay show={this.state.show}>
